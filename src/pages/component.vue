...
import navsData from "@/router/nav.config";
export default {
  data() {
    return {
      hover: false,
...
.page-component table td:first-child,
.page-component table th:first-child {
  padding-left: 10px;
}
.page-component ul:not(.timeline) {
  margin: 10px 0;
  padding: 0 0 0 20px;
  font-size: 14px;
  color: #5e6d82;
...
.page-component .back-top-fade-enter,
.page-component .back-top-fade-leave-active {
